...
class CalendarEvent(models.Model):
    ...
    def _create_google_meet(self, cal_event):
        for event in cal_event:
            ...
            print("end_date_user", end_date_user)
            print("start_dt", start_dt)
            print("finish_dt", finish_dt)
            ...
            stop_dt_adjusted = start_dt_adjusted + timedelta(
                ...
                minutes=difference.minutes)
            print("start_dt_adjusted", start_dt_adjusted)
            print("stop_dt_adjusted", stop_dt_adjusted)
            print("start_date", start_date)
            print("stop_date", stop_dt_adjusted)
            print("event", event)
